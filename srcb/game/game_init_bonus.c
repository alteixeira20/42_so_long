...
/*   Updated: 2025/10/01 16:21:43 by alteixeira20     ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../inc/so_long_bonus.h"

static int	handle_exit_wrapper(void *param)
{
	t_game				*game;
...
void	close_game(t_game *game, t_graphics *gfx)
{
	if (gfx->mlx)
	{
		...
		free_static_textures(gfx);
		free_move_textures(gfx);
		free_mining_textures(gfx);
...
void	start_game(t_game *game)
{
	...
	mlx_hook(game->gfx.window, 17, 0, handle_exit_wrapper, game);
